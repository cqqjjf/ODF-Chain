...
// Status implements accounts.Wallet, returning whodfer the account held by the
...
func (w *keystoreWallet) SelfDerive(bases []accounts.DerivationPath, chain odf.ChainStateReader) {
}
