...
func NewBalanceTracker(ns *nodestate.NodeStateMachine, setup BalanceTrackerSetup, db odfdb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *BalanceTracker {
...
// canDropBalance tells whodfer a positive or negative balance is below the threshold
