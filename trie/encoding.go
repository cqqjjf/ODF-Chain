...
// 'terminator' byte of value 0x10 which indicates whodfer or not the node at the key
...
// the second-lowest encoding whodfer the node at the key is a value node. The low nibble
...
// hasTerm returns whodfer a hex key has the terminator flag.
