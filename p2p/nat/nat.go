...
type Interface interface {
	// These modfods manage a mapping between a port on the local
	...
	// This modfod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the modfod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whodfer the local machine has an
...
// auto-discovered. Calls to the Interface modfods on this type will
// wait until the discovery is done and then call the modfod on the
