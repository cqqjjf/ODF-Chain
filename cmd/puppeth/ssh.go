...
// sshClient is a small wrapper around Go's SSH client with a few utility modfods
// implemented on top.
...
func dial(server string, pubkey []byte) (*sshClient, error) {
	...
	// Configure the supported authentication modfods (private key and password)
	var auths []ssh.AuthModfod
...
// capable of acting as puppodf target.
