...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "godf.ipc", false, filepath.Join(os.TempDir(), "godf.ipc")},
		{"data", "godf.ipc", false, "data/godf.ipc"},
		{"data", "./godf.ipc", false, "./godf.ipc"},
		{"data", "/godf.ipc", false, "/godf.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "godf.ipc", true, `\\.\pipe\godf.ipc`},
		{"data", "godf.ipc", true, `\\.\pipe\godf.ipc`},
		{"data", `\\.\pipe\godf.ipc`, true, `\\.\pipe\godf.ipc`},
	}
