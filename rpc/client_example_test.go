...
// known to the server. The server supports two modfods:
//
// odf_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// odf_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "odf_getBlockByNumber", "latest", false)
	if err != nil {
