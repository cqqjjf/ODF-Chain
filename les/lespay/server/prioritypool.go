...
// RequestCapacity checks whodfer changing the capacity of a node to the given target
...
// the minimum priority needed to do the change and whodfer it is currently allowed.
