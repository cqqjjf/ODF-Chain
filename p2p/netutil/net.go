...
// Contains reports whodfer the given IP is contained in the list.
...
// IsLAN reports whodfer an IP is a local network address.
...
// IsSpecialNetwork reports whodfer an IP is located in a special-use network range
...
// CheckRelayIP reports whodfer an IP relayed from the given sender IP
...
// SameNet reports whodfer two IP addresses have an equal prefix of the given bit length.
...
// Contains whodfer the given IP is contained in the set.
