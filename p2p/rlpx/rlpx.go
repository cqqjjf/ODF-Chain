...
import (
	...
	"github.com/odf/go-odf/crypto/ecies"
...
//
// Before sending messages, a handshake must be performed by calling the Handshake modfod.
...
// len(data) depending on whodfer snappy compression is enabled.
...
type authMsgV4 struct {
	gotPlain bool // whodfer read packet had plain format.
