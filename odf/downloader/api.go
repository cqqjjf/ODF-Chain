...
// It offers only modfods that operates on data that can be available to anyone without security risks.
...
type SyncingResult struct {
	...
	Status  odf.SyncProgress `json:"status"`
}
