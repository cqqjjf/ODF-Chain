...
// The app's SubscribeResults modfod starts sending calculation results to the given
// channel. Subscriptions created through this modfod are tied to the lifetime of the App
