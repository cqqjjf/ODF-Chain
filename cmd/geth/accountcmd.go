...
var (
	walletCommand = cli.Command{
		...
		Description: `
    godf wallet import /path/to/my/presale.wallet

will prompt for your password and imports your odfer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	godf wallet [options] /path/to/my/presale.wallet
...
between odf nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    godf account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    godf account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another odf instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := godfConfig{Node: defaultNodeConfig()}
	// Load config file.
