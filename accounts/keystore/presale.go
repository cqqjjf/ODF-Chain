...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/odf/pyodfsaletool

		pyodfsaletool generates the encryption key from password by
	...
	*/
	...
	odfPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(odfPriv)
