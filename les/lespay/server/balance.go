...
// checkCallbacks checks whodfer the threshold of any of the active callbacks
...
// checkPriorityStatus checks whodfer the node has gained priority status and sets the priority
