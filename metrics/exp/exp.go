...
import (
	...
	"github.com/odf/go-odf/metrics/promodfeus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/promodfeus", promodfeus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/promodfeus", promodfeus.Handler(metrics.DefaultRegistry))
