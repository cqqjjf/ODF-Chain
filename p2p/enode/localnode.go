...
// current process. Setting ENR entries via the Set modfod updates the record. A new version
// of the record is signed on demand when the Node modfod is called.
