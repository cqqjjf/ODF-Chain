...
type testEncoderValueModfod struct{}

func (e testEncoderValueModfod) EncodeRLP(w io.Writer) error {
...
var encTests = []encTest{
	...
	{val: struct{ E testEncoderValueModfod }{}, output: "C3FAFEF0"},
	{val: struct{ E *testEncoderValueModfod }{}, output: "C1C0"},

	// Verify that the Encoder interface works for unsupported types like func().
	{val: undecodableEncoder(func() {}), output: "F5F5F5"},

	// Verify that pointer modfod testEncoder.EncodeRLP is called for
	...
	{val: testEncoder{}, error: "rlp: unadressable value of type rlp.testEncoder, EncodeRLP is pointer modfod"},
