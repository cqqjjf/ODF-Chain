...
func ReadDatabaseVersion(db odfdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db odfdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db odfdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db odfdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
