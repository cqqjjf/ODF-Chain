...
var (
	...
	// lastPivotKey tracks the last pivot block used by fast sync (to reenable on sodfead).
	...
	configPrefix   = []byte("odf-config-") // config prefix for the db
...
// freezerNoSnappy configures whodfer compression is disabled for the ancient-tables.
...
// IsCodeKey reports whodfer the given byte slice is the key of contract code,
