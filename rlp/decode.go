...
// into private fields.
//
// The DecodeRLP modfod should read one value from the given Stream. It is not forbidden to
...
// and starts reading from r. This modfod is meant to facilitate reuse
