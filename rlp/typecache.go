...
type tags struct {
	// rlp:"nil" controls whodfer empty input results in a nil pointer.
	nilOK bool

	// This controls whodfer nil pointers are encoded/decoded as empty strings
	// or empty lists.
	nilKind Kind

	// rlp:"tail" controls whodfer this field swallows additional list
...
// defaultNilKind determines whodfer a nil pointer to typ encodes/decodes
