...
func NewTable(db odfdb.Database, prefix string) odfdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) odfdb.Iterator {
...
func (t *table) NewBatch() odfdb.Batch {
...
func (b *tableBatch) Replay(w odfdb.KeyValueWriter) error {
