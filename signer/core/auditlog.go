...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, modfodSelector *string) (*odfapi.SignTransactionResult, error) {
	sel := "<nil>"
	if modfodSelector != nil {
		sel = *modfodSelector
	}
	...
	res, e := l.api.SignTransaction(ctx, args, modfodSelector)
	if res != nil {
...
func (l *AuditLogger) SignGnosisSafeTx(ctx context.Context, addr common.MixedcaseAddress, gnosisTx GnosisSafeTx, modfodSelector *string) (*GnosisSafeTx, error) {
	sel := "<nil>"
	if modfodSelector != nil {
		sel = *modfodSelector
	}
	...
	res, e := l.api.SignGnosisSafeTx(ctx, addr, gnosisTx, modfodSelector)
	if res != nil {
