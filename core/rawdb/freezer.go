...
//   reserving it for go-odf. This would also reduce the memory requirements
//   of Godf, and thus also GC overhead.
type freezer struct {
...
// HasAncient returns an indicator whodfer the specified ancient data exists
// in the freezer.
...
func (f *freezer) freeze(db odfdb.KeyValueStore) {
	...
	for {
		...
		// Log somodfing friendly for the user
		context := []interface{}{
