...
// isInitDone returns whodfer the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whodfer the caller wants liveness-checked results. If
