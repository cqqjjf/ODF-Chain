...
var (
	_ Error = new(modfodNotFoundError)
...
type modfodNotFoundError struct{ modfod string }

func (e *modfodNotFoundError) ErrorCode() int { return -32601 }

func (e *modfodNotFoundError) Error() string {
	return fmt.Sprintf("the modfod %s does not exist/is not available", e.modfod)
}
