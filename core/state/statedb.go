...
// StateDB structs within the odf protocol are used to store anything
...
// This modfod will panic if the refund counter goes below zero
...
// Exist reports whodfer the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (s *StateDB) Exist(addr common.Address) bool {
	return s.getStateObject(addr) != nil
}

// Empty returns whodfer the state object is either non-existent
...
//
// Setting, updating & deleting state object modfods.
//
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/odf/go-odf/pull/16485#issuecomment-380438527),
		// and in the Finalise-modfod, there is a case where an object is in the journal but not
