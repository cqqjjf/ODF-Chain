...
// mutuallyAuthenticate is an internal modfod to authenticate both ends of the
// connection.
...
// open is an internal modfod that sends an open APDU.
...
// pair is an internal modfod that sends a pair APDU.
...
// encryptAPDU is an internal modfod that serializes and encrypts an APDU.
...
// decryptAPDU is an internal modfod that decrypts and deserializes an APDU.
...
// updateIV is an internal modfod that updates the initialization vector after
