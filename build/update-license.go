...
Please review the resulting diff to check whodfer the correct
...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/odf/go-odf/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-odf authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-odf Authors
