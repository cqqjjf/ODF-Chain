...
func TestClientBatchRequest(t *testing.T) {
	...
	wantResult := []BatchElem{
		...
		},
		{
			...
			Args:   []interface{}{1, 2, 3},
			Result: new(int),
			Error:  &jsonError{Code: -32601, Message: "the modfod no_such_modfod does not exist/is not available"},
		},
	}
...
// This test reproduces https://github.com/odf/go-odf/issues/17837 where the
...
func TestClientReconnect(t *testing.T) {
	...
	// We spawn multiple calls here to check whodfer this hangs somehow.
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-odf-test-ipc-%d-%d", os.Getpid(), rand.Int63())
