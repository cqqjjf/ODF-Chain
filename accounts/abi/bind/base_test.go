...
func (mc *mockCaller) CallContract(ctx context.Context, call odf.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call odf.CallMsg) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, nil, "somodfing")
	...
	bc.Call(&bind.CallOpts{}, nil, "somodfing")
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "somodfing")
