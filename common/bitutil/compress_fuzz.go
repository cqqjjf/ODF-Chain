...
// Fuzz implements a go-fuzz fuzzer modfod to test various encoding modfod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer modfod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer modfod to test the bit decoding and
