...
// API describes the set of modfods offered over the RPC interface
type API struct {
	Namespace string      // namespace under which the rpc modfods of Service are exposed
	Version   string      // api version for DApp's
	Service   interface{} // receiver instance which holds the modfods
	Public    bool        // indication if the modfods must be considered safe for public use
}
