...
const (
	// OptionModfodInvocation is an indication that the codec supports RPC modfod calls
	OptionModfodInvocation CodecOption = 1 << iota
...
func NewServer() *Server {
	...
	// as the services and modfods it offers.
