...
var (
	...
	odfashChainConfig *params.ChainConfig
...
func init() {
	...
	odfashChainConfig = params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db odfdb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db odfdb.Database, blocks int) (*worker, *testWorkerBackend) {
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, odfashChainConfig, odfash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	odfash := odfash.NewFaker()
	defer odfash.Close()

	w, b := newTestWorker(t, odfashChainConfig, odfash, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, odfashChainConfig, odfash.NewFaker())
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, odfashChainConfig, odfash.NewFaker())
}
