...
const protocolName = "odf"

// ProtocolVersions are the supported versions of the odf protocol (first is primary).
var ProtocolVersions = []uint{odf65, odf64, odf63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{odf65: 17, odf64: 17, odf63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// odf protocol message codes
const (
	StatusMsg          = 0x00
	...
	// New protocol message codes introduced in odf65
	//
	// Previously these message ids were used by some legacy and unsupported
	// odf protocols, reown them here.
...
// statusData63 is the network packet for the status message for odf/63.
...
// statusData is the network packet for the status message for odf/64 and later.
