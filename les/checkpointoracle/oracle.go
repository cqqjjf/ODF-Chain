...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whodfer the contract backend is set or not
...
// IsRunning returns an indicator whodfer the oracle is running.
...
// checks whodfer there are enough approvals to finalize the checkpoint.
