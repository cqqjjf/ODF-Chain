...
// Package forkid implements EIP-2124 (https://eips.odf.org/EIPS/eip-2124).
package forkid
...
// Blockchain defines all necessary modfod to build a forkID.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // Somodfing's very wrong, accept rather than reject
	}
}
