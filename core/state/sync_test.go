...
// account array.
func checkStateAccounts(t *testing.T, db odfdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db odfdb.Database, root common.Hash) error {
...
func checkStateConsistency(db odfdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	// isCode reports whodfer the hash is contract code hash.
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(odfdb.Database), srcRoot)
