...
// CreateAddress creates an odf address given the bytes and the nonce
func CreateAddress(b common.Address, nonce uint64) common.Address {
	data, _ := rlp.EncodeToBytes([]interface{}{b, nonce})
	return common.BytesToAddress(Keccak256(data)[12:])
}

// CreateAddress2 creates an odf address given the address bytes, initial
...
// controls whodfer the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whodfer the signature values are valid with
