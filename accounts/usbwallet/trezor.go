...
import (
	...
	"github.com/odf/go-odf/accounts/usbwallet/trezor"
...
type trezorDriver struct {
	...
	pinwait        bool          // Flags whodfer the device is waiting for PIN entry
	passphrasewait bool          // Flags whodfer the device is waiting for passphrase entry
...
// Status implements accounts.Wallet, always whodfer the Trezor is opened, closed
// or whodfer the Ethereum app was not started on it.
...
// modfod will also return the index of the destination object used.
