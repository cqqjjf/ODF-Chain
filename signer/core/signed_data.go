...
// determineSignatureFormat determines which signature modfod should be used based upon the mime type
...
// This modfod returns the mimetype for signing along with the request
...
//
// The modfod requires the extra data to be at least 65 bytes -- the original implementation
