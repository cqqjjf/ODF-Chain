...
type stateObject struct {
	...
	addrHash common.Hash // hash of odf address of the account
	data     Account
	db       *StateDB
...
// empty returns whodfer the account is considered empty.
...
// or zero if none. This modfod is an almost mirror of Code, but uses a cache
