...
// See https://github.com/odf/EIPs/issues/176 for the test format specification.
...
func MakePreState(db odfdb.Database, accounts core.GenesisAlloc, snapshotter bool) (*snapshot.Tree, *state.StateDB) {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/odf/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
