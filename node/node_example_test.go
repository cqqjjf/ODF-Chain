...
//
// The following modfods are needed to implement a node.Lifecycle:
//  - Start() error              - modfod invoked when the node is ready to start the service
//  - Stop() error               - modfod invoked when the node terminates the service
