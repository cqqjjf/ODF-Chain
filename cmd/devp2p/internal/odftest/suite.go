...
// Suite represents a structure used to test the odf
...
// NewSuite creates and returns a new odf-test suite that can
...
// TestGetBlockHeaders tests whodfer the given node can respond to
...
// TestGetBlockBodies tests whodfer the given node can respond to
...
// TestBroadcast tests whodfer a block announcement is correctly
