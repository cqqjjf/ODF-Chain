...
func (ui *StdIOUI) dispatch(serviceModfod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceModfod, args)
	if err != nil {
...
func (ui *StdIOUI) notify(serviceModfod string, args interface{}) error {
	ctx := context.Background()
	err := ui.client.Notify(ctx, serviceModfod, args)
	if err != nil {
		log.Info("Error", "exc", err.Error())
	}
	return err
...
func (ui *StdIOUI) OnApprovedTx(tx odfapi.SignTransactionResult) {
